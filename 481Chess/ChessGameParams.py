...
class TkinterGameSetupParams:
	...
	def __init__(self):
		...
		Radiobutton(self.frame, text="Heuristic AI",variable=self.tk_player1Type,value="heuristicAI").grid(row=2,column=3)
		...
		Radiobutton(self.frame, text="Heuristic AI",variable=self.tk_player2Type,value="heuristicAI").grid(row=3,column=3)
