...
class PythonChessMain:
        ...
        def SetUp(self,options):
                ...
                elif player1Type == 'heuristicAI':
                        self.player[0] = ChessAI_heuristic(player1Name,player1Color)
                ...
                elif player2Type == 'heuristicAI':
                        self.player[1] = ChessAI_heuristic(player2Name,player2Color)
        ...
        def MainLoop(self):
                ...
                while not self.Rules.IsCheckmate(self.Board.GetState(),self.player[currentPlayerIndex].color):
                        ...
                        #Create game state tree (kevin)
                        gameStateTree = Tree(self.Board)
                        gameStateTree.create_tree(currentColor,self.Rules)
